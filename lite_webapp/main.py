...
forecast = pd.read_csv('dataP/lightForcast.csv')
# check
# This still temp
...
prediction_allmodelfig = px.line(forecast, x="Date", y=forecast.columns[1:]).add_scatter(
        ...
        html.Div(
            ...
            children=[html.B('Electricity generation & consumption segmentation'), html.Hr(),
                    ...
                    #   html.Button('Submit', id='submit-val', n_clicks=0),
                      ...
                      dcc.Graph(figure=fig_month, id='fig_month_id')]
